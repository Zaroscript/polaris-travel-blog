    ...
    const posts = [
      {
        ...
        coverImage: "https://images.unsplash.com/photo-1474044159687-1ee9f3a51722",
        author: {
          _id: users[0]._id,
      ...
      },
      {
        ...
        comments: [
          {
            content: "The photos are stunning! What's your favorite spot for hanami?",
            author: {
              _id: users[4]._id,
            ...
            replies: [
              {
                content: "Maruyama Park is magical, but Philosopher's Path is my favorite!",
                author: {
                  _id: users[3]._id,
                  fullName: users[3].fullName,
                  profilePic: users[3].profilePic
      ...
      },
      {
        ...
        coverImage: "https://images.unsplash.com/photo-1529108190281-9d6ebf35a776",
        author: {
          _id: users[4]._id,
          fullName: users[4].fullName,
          profilePic: users[4].profilePic,
        ...
        comments: [
          {
            content: "How was the temperature? I've heard it can get quite hot!",
            author: {
              _id: users[0]._id,
              fullName: users[0].fullName,
              profilePic: users[0].profilePic,
            ...
            replies: [
              {
                content: "It was around 35°C during the day, but the nights were cool and perfect for stargazing!",
                author: {
                  _id: users[4]._id,
                  fullName: users[4].fullName,
                  profilePic: users[4].profilePic,
      ...
      },
      {
        ...
        content: "Watching the sun dip into the Aegean Sea from Oia is pure magic! The white-washed buildings turn golden, and the sky explodes in colors. Greek hospitality and food are unmatched! 🌅 #Greece #Santorini",
        ...
        comments: [
          {
            ...
            replies: [
              {
                content: "Apsithia - amazing sunset views and the seafood was incredible!",
                author: {
                  _id: users[0]._id,
                  fullName: users[0].fullName,
                  profilePic: users[0].profilePic
      ...
      },
      {
        ...
        content: "Finally witnessed the mesmerizing Aurora Borealis in Iceland! The green lights dancing across the night sky created an otherworldly experience. The hot springs and glaciers add to the magic! ❄️ #Iceland #NorthernLights",
        coverImage: "https://images.unsplash.com/photo-1579033461380-adb47c3eb938",
        author: {
          _id: users[1]._id,
          fullName: users[1].fullName,
          profilePic: users[1].profilePic
      ...
      },
      {
        ...
        content: "Completed the Inca Trail to Machu Picchu! Four days of challenging hiking through stunning mountain passes led to the most rewarding view. The ancient Incan architecture is mind-blowing! 🏔️ #MachuPicchu #Peru",
        ...
        comments: [
          {
            ...
            replies: [
              {
                content: "Challenging but doable with proper preparation. Dead Woman's Pass was the toughest part!",
                author: {
                  _id: users[2]._id,
                  fullName: users[2].fullName,
                  profilePic: users[2].profilePic
